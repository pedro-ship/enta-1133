    ...
    public class GameManager {
        ...
        private void GameLoop() {
            ...
            while (gameIsActive) {
                ...
                Console.WriteLine("3: Check life points");
                ...
                switch (optionAnswer) {
                    ...
                    case "3": // Option "3" check life points
                    ...
                    case "4": // Option "4" check inventory
                        player.InventoryInstance.CheckInventory();
                        Console.WriteLine();
                        break;

                    case "5": // Option "5" use item
                        Console.WriteLine("Code still need to be done");
                        break;

                    case "6": // Option "6" quit game
                        Console.WriteLine(); // blank space
